...
@section('content')
    ...
    <div class="footer-block food-products-footer">
        <div class="footer-text food-products-footer-text">
            ...
            <ol>
                <li>
                    <a href=""><strong>Сено — основа всего.</strong></a> Оно должно быть в доступе 24/7. Сено
                    стачивает зубы и налаживает пищеварение.
                </li>
                <li>
                    <a href=""><strong>Витамин C обязателен.</strong></a> Морские свинки, как и люди, не синтезируют
                    этот витамин. Его источники: свежие овощи (болгарский перец, петрушка).
                </li>
                <li>
                    <a href=""><strong>Новые продукты вводите постепенно.</strong></a> Даже полезную морковь или яблоко
                    давайте маленькими кусочками и следите за реакцией организма.
                </li>
                <li>
                    <a href=""><strong>Запрещенные продукты — не шутка.</strong></a> Лук, чеснок, картофель, молочные
