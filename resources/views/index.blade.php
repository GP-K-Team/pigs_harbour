...
@section('full_title', 'Пристань пушистых сердец | Помощь бездомным морским свинкам')
@section('description', '💞 Пристань пушистых сердец — сообщество помощи морским свинкам. Даем приют в Москве, Санкт-Петербурге, Краснодаре, Перми, ищем новых хозяев с отправкой по России.')
