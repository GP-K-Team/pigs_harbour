<div class="mobile-nav-wrapper">
    ...
    <div class="close-nav-button">
        <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path class="close-menu_svg" d="M25.8076 2.73047L15.2305 13.3076L25.8076 23.8848L23.8848 25.8076L13.3076 15.2305L2.73047 25.8076L0.807617 23.8848L11.3848 13.3076L0.807617 2.73047L2.73047 0.807617L13.3076 11.3848L23.8848 0.807617L25.8076 2.73047Z" fill="#323232"/>
        </svg>
    </div>
</div>
...
<style>
    ...
    .close-nav-button:hover .close-menu_svg,
    li .vk-link:hover .main-vk-logo {
